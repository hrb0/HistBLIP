...
from modules.trainer_AllinOne import Trainer_histgen, Trainer_BLIP
from modules.loss import compute_loss
from models.histgen_model import HistGenModel
from models.histblip_model import HistBLIP
...
def parse_agrs():
    ...
    parser.add_argument('--model', type=str, default='Histgen', choices=['Histgen','BLIP'])
    parser.add_argument('--model_vis', type=str, default='CONCH', choices=['UNI','CONCH'])
...
def main():
    ...
    if args.model == 'Histgen':
        trainer = Trainer_histgen(model, criterion, metrics, optimizer, args, lr_scheduler, train_dataloader, val_dataloader, test_dataloader)
    elif args.model == 'BLIP':
        trainer = Trainer_BLIP(model, criterion, metrics, optimizer, args, lr_scheduler, train_dataloader, val_dataloader, test_dataloader)
