...
from modules.tester_AllinOne import Tester, Tester_BLIP
...
def parse_agrs():
    ...
    parser.add_argument('--format', type=str, default='full', choices=['full','middle'])
...
def main():
    ...
    if args.model == 'Histgen':
        ...
        tester = Tester_BLIP(model, criterion, metrics, args, test_dataloader)
    tester.test()
